let kitap1={ isim:"da vinci şifresi", yazar:"dan brown", fiyat:120, raf:"1.2.RAF"}
let kitap2={ isim:"serenad", yazar:"zülfü livaneli", fiyat:110, raf:"2.4.RAF"}
let kitap3={ isim:"satranç", yazar:"stefan zweig", fiyat:18, raf:"4.3.RAF"}
let kitap4={ isim:"fareler ve insanlar", yazar:"john steinbeck", fiyat:45, raf:"5.1.RAF"}
let kitap5={ isim:"uçurtma avcısı", yazar:"khaled hosseini", fiyat:93, raf:"3.5.RAF"}
...
rafOlustur();
let kitapIsmi=prompt("bir kitap adi giriniz");
